...
const jobSchema = new mongoose.Schema({
  ...
  allApplicants: [{ type: mongoose.Schema.Types.ObjectId, ref: 'Applicant' }],  // Assuming Applicant model
  shortlistedApplicants: [{ type: mongoose.Schema.Types.ObjectId, ref: 'Applicant' }],
